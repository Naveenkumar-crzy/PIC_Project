...
void keypad(){
    ...
    if (PORTCbits.RC0 ==1 ){ lcd_data('1');while (PORTCbits.RC0 ==1); }
     if (PORTCbits.RC1 ==1 ){ lcd_data('4');while (PORTCbits.RC1 ==1); }
     if (PORTCbits.RC2 ==1){ lcd_data('7');while (PORTCbits.RC2==1); }
     if (PORTCbits.RC3 ==1 ){ lcd_data('*');while (PORTCbits.RC3 ==1); }
     PORTBbits.RB3 = 0; PORTBbits.RB4 = 1; PORTBbits.RB5 = 0;
    if (PORTCbits.RC0 ==1){ lcd_data('2');while (PORTCbits.RC0 ==1); }
     if (PORTCbits.RC1 ==1 ){ lcd_data('5');while (PORTCbits.RC1 ==1); }
     if (PORTCbits.RC2 ==1 ){ lcd_data('8');while (PORTCbits.RC2 ==1); }
     if (PORTCbits.RC3 ==1 ){ lcd_data('0');while (PORTCbits.RC3 ==1); }
      PORTBbits.RB3 = 0; PORTBbits.RB4 = 0; PORTBbits.RB5 = 1;
    if (PORTCbits.RC0 ==1 ){ lcd_data('3');while (PORTCbits.RC0==1); }
     if (PORTCbits.RC1 ==1 ){ lcd_data('6');while (PORTCbits.RC1 ==1); }
     if (PORTCbits.RC2 ==1 ){ lcd_data('9');while (PORTCbits.RC2 ==1); }
     if (PORTCbits.RC3 ==1 ){ lcd_data('#');while (PORTCbits.RC3==1); }
}
